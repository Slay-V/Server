    ...
    public class PlayerSpawn : Script
    {
        ...
        public static void registerUser(Client c, string username)
        {
            ...
            if (count != 1)
            {
                ...
                {
                    "TextInputBox",
                    "{\"textBoxObject\":{\"Title\":\"Anmeldeformular\",\"Message\":\"Gebe bitte deinen Benutzernamen ein (Beispiel: Vorname_Nachname). Falls du noch nicht registriert bist, wirst du automatisch registriert! Im nächsten Schritt kannst du dir dein Passwort auswählen.\",\"Callback\":\"registerUser\",\"CloseCallback\":\"showLoginInput\"}}"
                });
                return;
            }
            ...
            if (vorname == nachname)
            {
                ...
                {
                    "TextInputBox",
                    "{\"textBoxObject\":{\"Title\":\"Anmeldeformular\",\"Message\":\"Gebe bitte deinen Benutzernamen eregisterUserin (Beispiel: Vorname_Nachname). Falls du noch nicht registriert bist, wirst du automatisch registriert! Im nächsten Schritt kannst du dir dein Passwort auswählen.\",\"Callback\":\"registerUser\",\"CloseCallback\":\"showLoginInput\"}}"
                });
                return;
            }
            else
